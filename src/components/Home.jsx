  ...
  return (
    <div name='home' className='w-full h-screen bg-[#272930]'>
        ...
        <div className='max-w-[1000px] mx-auto px-2 flex flex-col justify-center h-full'>
            ...
            <h2 className='text-4xl sm:text-7xl font-bold text-[#8892b0]'>I'm a Junior Full-Stack Developer</h2>
            <p className='text-[#8892b0] py-4 max-w-[700px]'>I am a junior full-stack developer who has recently graduated from the LeWagon web development course. 
            I am interested in oppurtunites to expand on these skills to create exceptional digital experiences
            and building responsive ful-stack applications. I love it</p>
                <div>
